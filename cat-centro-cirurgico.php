			...
			<div class="row">
				<div class="col-md-12">
					<ul class="breadcrumb">
						...
						<li class="active">Centro Cirúrgico</li>
					</ul>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-pills">
						<li><a data-hash data-hash-offset="149" href="#first">Sistemas de Anestesia</a></li>
						<li><a data-hash data-hash-offset="149" href="#second">Estativas</a></li>
						<li><a data-hash data-hash-offset="149" href="#third">Foco Cirúrgico</a></li>
						<li><a data-hash data-hash-offset="149" href="#four">Mesa Cirúrgica</a></li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div role="main" class="main shop">
					<div id="#content-scroll" class="container">
									...
									<span class="product-thumb-info">
										...
										<a href="">
											<span class="product-thumb-info-image">
												...
												<img alt="" class="img-responsive" src="img/products/ETV-DM.jpg">
											</span>
										</a>
										<span class="product-thumb-info-content">
											<a href="">
									...
									<span class="product-thumb-info">
										...
										<a href="">
											<span class="product-thumb-info-image">
												...
												<img alt="" class="img-responsive" src="img/products/ETV-QJ2.jpg">
											</span>
										</a>
										<span class="product-thumb-info-content">
											<a href="">
									...
									<span class="product-thumb-info">
										...
										<a href="">
											<span class="product-thumb-info-image">
												...
												<img alt="" class="img-responsive" src="img/products/ETV-SJ.jpg">
											</span>
										</a>
										<span class="product-thumb-info-content">
											<a href="">
						...
						<div class="row" id="third">
							<div class="col-md-6">
								<h1 class="mb-none"><strong>Foco Cirúrgico</strong></h1>
							</div>
						</div>
									...
									<span class="product-thumb-info">
										...
										<a href="">
											<span class="product-thumb-info-image">
												...
												<img alt="" class="img-responsive" src="img/products/FocoCirúrgicoLED-Quanta.jpg">
											</span>
										</a>
										<span class="product-thumb-info-content">
											<a href="">
									...
									<span class="product-thumb-info">
										...
										<a href="">
											<span class="product-thumb-info-image">
												...
												<img alt="" class="img-responsive" src="img/products/FocoCirúrgico-Centra.jpg">
											</span>
										</a>
										<span class="product-thumb-info-content">
											<a href="">
						...
						<div class="row" id="four">
							<div class="col-md-6">
								<h1 class="mb-none"><strong>Mesa Cirúrgica</strong></h1>
							</div>
						</div>
						<div class="row">
							<ul class="products product-thumb-info-list" data-plugin-masonry>
									...
									<span class="product-thumb-info">
										...
										<a href="">
											<span class="product-thumb-info-image">
												...
												<img alt="" class="img-responsive" src="img/products/MesaCirúrgica RadiotransparenteElétricaAtenaA-500.jpg">
											</span>
										</a>
										<span class="product-thumb-info-content">
											<a href="">
									...
									<span class="product-thumb-info">
										...
										<a href="">
											<span class="product-thumb-info-image">
												...
												<img alt="" class="img-responsive" src="img/products/MesaCirúrgicaRadiotransparenteElétroHidráulicaAtenaA-900.jpg">
											</span>
										</a>
										<span class="product-thumb-info-content">
											<a href="">
