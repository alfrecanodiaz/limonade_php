			...
			<div class="row">
				<div class="col-md-12">
					<ul class="breadcrumb">
						...
						<li class="active">Monitores Multiparâmetros</li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<h1>Monitores Multiparâmetros</h1>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="nav nav-pills">
						<li><a data-hash data-hash-offset="149" href="#first">Monitor Multiparâmetro</a></li>
						<li><a data-hash data-hash-offset="149" href="#second">Monitor de Sinais Vitais</a></li>
