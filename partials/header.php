					...
					<div class="header-row">
						...
						<nav class="header-nav-top">
							<ul class="nav nav-pills">
								<li class="hidden-xs">
									<a href="about-us.php"><i class="fa fa-angle-right"></i> Sobre Nós</a>
								</li>
								<li class="hidden-xs">
									<a href="contact-us.php"><i class="fa fa-angle-right"></i> Entre em contato</a>
								</li>
								<li>
								...
								<li>
									<a href="#" class="dropdown-menu-toggle" id="dropdownLanguage" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
										<img src="img/blank.gif" class="flag flag-br" alt="Espanõl" /> Português
									...
									<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
										...
										<li><a href="#"><img src="img/blank.gif" class="flag flag-br" alt="Português" /> Português</a></li>
									</ul>
								</li>
							</ul>
						</nav>
							...
							<div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1 collapse">
								<nav>
									<ul class="nav nav-pills" id="mainNav">
										<li class="nav-li">
											<a class="nav-page" href="index.php">Home</a>
										</li>
										<li class="nav-li">
											<a class="nav-page" href="about-us.php">A Empresa</a>
										</li>
										<li class="nav-li">
											<a class="nav-page" href="solucoes.php">Soluções</a>
										</li>
										...
										<li class="nav-li">
											<a class="nav-page" href="assist.php">Assistência Técnica</a>
										</li>
										<li class="nav-li">
											<a class="nav-page" href="blog.php">Blog</a>
										</li>
										<li class="nav-li">
											<a class="nav-page" href="contact-us.php">Contato</a>
										</li>
